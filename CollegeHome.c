...
int main()
{
  ...
  gotoxy(65,19);
  printf("6. LIBRARY SECTION");
  gotoxy(65,21);
  printf("7. PLACEMENT SECTION");
  gotoxy(65,23);
  printf("8. EVENT MANAGEMENT SECTION");
  gotoxy(65,25);
  printf("9. STUDENT ATTENDANCE SECTION");
  gotoxy(65,27);
  printf("10. STUDENT GRADING SECTION");
  gotoxy(65,29);
  printf("11. Exit");
  gotoxy(50,31);
  printf("=========================================================================");
